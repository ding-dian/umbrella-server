...
public class TencentSmsOperator {
    ...
    public boolean sendSms() {
        try {
            ...
            /* 模板参数: 若无模板参数，则设置为空 */
            String[] templateParamSet = {"99999","3"};
            ...
            String responsJsonStr = SendSmsResponse.toJsonString(res);
            log.info("Response: {}", responsJsonStr);
            JSONObject response = JSONUtil.parseObj(responsJsonStr);
